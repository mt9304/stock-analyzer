...
public class ND9Industry extends ND4AnalystRecommendation
{
	...
	public String getIndustry() throws InterruptedException, InterruptedException, FileNotFoundException {
	...
	public String getSector() throws InterruptedException, InterruptedException, FileNotFoundException {
		Element sectorNode;
		try {
